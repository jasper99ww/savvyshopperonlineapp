...
import com.example.savvyshopperonlineapp.ui.theme.Purple40
...
fun SignInScreen(
    ...
    Column(
        ...
        Image(
            painter = painterResource(id = R.drawable.grocery_cart),
...
//            .padding(12.dp))
        ...
        TextButton(onClick = navigateToForgotPassword) {
            Text(text = stringResource(R.string.forgot_password), fontSize = 16.sp)
        }
